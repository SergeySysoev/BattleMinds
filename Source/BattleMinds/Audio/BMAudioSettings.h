...
#include "BMAudioSettings.generated.h"

class UObject;
class USoundEffectSubmixPreset;
class USoundSubmix;

UCLASS(config = Game, defaultconfig, meta = (DisplayName = "BattleMindsAudioSettings"))
class BATTLEMINDS_API UBMAudioSettings : public UDeveloperSettings
{
	GENERATED_BODY()
