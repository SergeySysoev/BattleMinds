...
#include "SettingValueDiscrete_Resolution.generated.h"
...
UCLASS()
class BATTLEMINDS_API USettingValueDiscrete_Resolution : public UGameSettingValueDiscrete
{
	GENERATED_BODY()

public:

	USettingValueDiscrete_Resolution();
