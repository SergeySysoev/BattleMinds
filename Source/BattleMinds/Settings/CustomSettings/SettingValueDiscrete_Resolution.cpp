...
#include "SettingValueDiscrete_Resolution.h"
#include "Framework/Application/SlateApplication.h"
#include "GameFramework/GameUserSettings.h"
#include "RHI.h"
#include "UnrealEngine.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(SettingValueDiscrete_Resolution)

#define LOCTEXT_NAMESPACE "BMSettings"

USettingValueDiscrete_Resolution::USettingValueDiscrete_Resolution()
{
}

void USettingValueDiscrete_Resolution::OnInitialized()
{
	Super::OnInitialized();
...
void USettingValueDiscrete_Resolution::StoreInitial()
{
	// Ignored
}

void USettingValueDiscrete_Resolution::ResetToDefault()
{
	// Ignored
}

void USettingValueDiscrete_Resolution::RestoreToInitial()
{
	// Ignored
}

void USettingValueDiscrete_Resolution::SetDiscreteOptionByIndex(int32 Index)
{
...
int32 USettingValueDiscrete_Resolution::GetDiscreteOptionIndex() const
{
...
TArray<FText> USettingValueDiscrete_Resolution::GetDiscreteOptions() const
{
...
void USettingValueDiscrete_Resolution::OnDependencyChanged()
{
...
void USettingValueDiscrete_Resolution::InitializeResolutions()
{
	Resolutions.Empty();
...
void USettingValueDiscrete_Resolution::SelectAppropriateResolutions()
{
...
bool USettingValueDiscrete_Resolution::ShouldAllowFullScreenResolution(const FScreenResolutionRHI& SrcScreenRes, int32 FilterThreshold) const
{
...
int32 USettingValueDiscrete_Resolution::FindIndexOfDisplayResolution(const FIntPoint& InPoint) const
{
...
int32 USettingValueDiscrete_Resolution::FindIndexOfDisplayResolutionForceValid(const FIntPoint& InPoint) const
{
...
int32 USettingValueDiscrete_Resolution::FindClosestResolutionIndex(const FIntPoint& Resolution) const
{	
	int32 Index = 0;
...
void USettingValueDiscrete_Resolution::GetStandardWindowResolutions(const FIntPoint& MinResolution, const FIntPoint& MaxResolution, float MinAspectRatio, TArray<FIntPoint>& OutResolutions)
{
...
FText USettingValueDiscrete_Resolution::FScreenResolutionEntry::GetDisplayText() const
{
