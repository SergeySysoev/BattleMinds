...
#include "SettingValueDiscreteDynamic_AudioOutputDevice.generated.h"
...
UCLASS()
class BATTLEMINDS_API USettingValueDiscreteDynamic_AudioOutputDevice : public UGameSettingValueDiscreteDynamic
{
	GENERATED_BODY()

public:

	virtual ~USettingValueDiscreteDynamic_AudioOutputDevice() = default;
