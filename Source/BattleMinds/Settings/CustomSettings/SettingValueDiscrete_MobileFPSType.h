...
#include "SettingValueDiscrete_MobileFPSType.generated.h"

enum class EGameSettingChangeReason : uint8;
class UObject;

UCLASS()
class BATTLEMINDS_API USettingValueDiscrete_MobileFPSType : public UGameSettingValueDiscrete
{
	GENERATED_BODY()

public:

	USettingValueDiscrete_MobileFPSType();
