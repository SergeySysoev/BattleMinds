...
#include "BMSettingsLocal.generated.h"
...
class UBMAudioSettings;
class UBMPlatformEmulationSettings;
struct FFrame;
...
UCLASS()
class BATTLEMINDS_API UBMSettingsLocal : public UGameUserSettings
{
	GENERATED_BODY()
...
private:
	...
	void OverrideQualityLevelsToScalabilityMode(const FScalabilitySnapshot& InMode, Scalability::FQualityLevels& InOutLevels);
...
private:
	...
	// Audio - Volume
public:
	DECLARE_EVENT_OneParam(UBMSettingsLocal, FAudioDeviceChanged, const FString& /*DeviceId*/);
