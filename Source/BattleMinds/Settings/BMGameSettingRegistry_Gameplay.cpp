...
#include "CustomSettings/SettingValueDiscrete_Language.h"
...
UGameSettingCollection* UBMGameSettingRegistry::InitializeGameplaySettings(UBMLocalPlayer* InLocalPlayer)
{
...

	{
		...
		//----------------------------------------------------------------------------------
		{
			USettingValueDiscrete_Language* Setting = NewObject<USettingValueDiscrete_Language>();
