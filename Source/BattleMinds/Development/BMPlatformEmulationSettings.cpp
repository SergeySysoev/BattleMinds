...
#include "BMPlatformEmulationSettings.h"
...
#define LOCTEXT_NAMESPACE "BMCheats"

UBMPlatformEmulationSettings::UBMPlatformEmulationSettings()
{
}

FName UBMPlatformEmulationSettings::GetCategoryName() const
{
	return FApp::GetProjectName();
}

FName UBMPlatformEmulationSettings::GetPretendBaseDeviceProfile() const
{
	return PretendBaseDeviceProfile;
}

FName UBMPlatformEmulationSettings::GetPretendPlatformName() const
{
	return PretendPlatform;
}

#if WITH_EDITOR
void UBMPlatformEmulationSettings::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
{
...
void UBMPlatformEmulationSettings::PostReloadConfig(FProperty* PropertyThatWasLoaded)
{
...
void UBMPlatformEmulationSettings::PostInitProperties()
{
...
void UBMPlatformEmulationSettings::OnPlayInEditorStarted() const
{
...
void UBMPlatformEmulationSettings::ApplySettings()
{
...
void UBMPlatformEmulationSettings::ChangeActivePretendPlatform(FName NewPlatformName)
{
...
TArray<FName> UBMPlatformEmulationSettings::GetKnownPlatformIds() const
{
...
TArray<FName> UBMPlatformEmulationSettings::GetKnownDeviceProfiles() const
{
	TArray<FName> Results;
...
void UBMPlatformEmulationSettings::PickReasonableBaseDeviceProfile()
{
